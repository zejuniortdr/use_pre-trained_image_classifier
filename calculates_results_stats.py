...
#
# PROGRAMMER: JOSE LUIS DA CRUZ  JUNIOR
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if all([results_dic[key][2], results_dic[key][3], results_dic[key][4]]):
    ...
    results_stats_dic["pct_match"] = (
        100.0 * results_stats_dic["n_match"] / results_stats_dic["n_images"]
    )
    ...
    results_stats_dic["pct_correct_dogs"] = (
        100.0 * results_stats_dic["n_correct_dogs"] / results_stats_dic["n_dogs_img"]
    )
    ...
    results_stats_dic["pct_correct_breed"] = (
        100.0 * results_stats_dic["n_correct_breed"] / results_stats_dic["n_dogs_img"]
    )
    ...
    try:
        results_stats_dic["pct_correct_notdogs"] = (
            100.0 * results_stats_dic["n_correct_notdogs"] / results_stats_dic["n_notdogs_img"]
        )
